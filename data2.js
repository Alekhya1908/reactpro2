...
loadJsonFile("data.json",function(text){
    ...
    console.log(data);
   detais(data.o[1].details);
   detais1(data.o[1].cardsdata);
   skills(data.o[1].skill);
   hobbies(data.o[1].hobby);
   achieves(data.o[1].achieve);
...
r.appendChild(d1);
 ...
 for(i in sdc)
 {
     ...
     li.textContent="Institute - "+sdc[i].name;
     ul.appendChild(li);

     var li1=document.createElement("li");
     li1.textContent="passing year - "+sdc[i].year;
     ul.appendChild(li1);

     var li1=document.createElement("li");
     li1.textContent="Percentage - "+sdc[i].Percent;
     ul.appendChild(li1);
     r.appendChild(ul);
